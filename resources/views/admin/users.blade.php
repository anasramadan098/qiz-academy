...
@section('content')
    <div id="users">
        <div class="d-flex">
            ...
            <a href="#" class="btn add-user-btn">Add User</a>
        </div>
        <div class="boxes">
            <div class="head box">
                <h4>User Name </h4>
            ...
            <div class="box">
                ...
                <div class="btns">
                    <a href="?edit-user={{$user->id}}" class="btn edit-user-btn">Edit</a>
                    <a href="/remove-user-{{$user->id}}" class="btn">Remove</a>
                </div>   
            </div>
            @endforeach
        </div>
    ...
    <div class="user-form hide">
        ...
        @if (request()->has('edit-user'))
            <form action="/edit-user-{{$user->id}}" method="POST">
                ...
                <div class="input">
                    <label>Gender</label>
                    <select class="fill" value="{{$user->gender}}" name="gender">
                ...
                <div class="input">
                    ...
                    <input value="{{$user->date}}" class="fill" type="date" name="date">
                </div>
                <input type="text"  name="email" placeholder="Email" value="{{$user->email}}">
                <input type="tel" name="phone" placeholder="Phone" value="{{$user->phone}}">
                <input type="text" name="username" placeholder="Username" value="{{$user->username}}">            
                <input type="text" name="street_1" placeholder="street 1" value="{{$user->street_1}}">
                <input type="text" name="street_2" placeholder="street 2" value="{{$user->street_2}}">
                ...
                <select name="country" value="{{$user->country}}">
                    ...
                    <option value="CI">Cote dDIvoire</option>
                ...
                <input type="submit" value="Uptade" class="btn"/>
        ...
        @else
            ...
            <form action="/save-user" method="POST">
                ...
                <div class="input">
                    <label>Date Of Birth</label>
                    <input class="fill" type="date" name="date">
                </div>
    ...
    <script>
        ...
        if (location.search.slice(1,10) == 'edit-user') {
