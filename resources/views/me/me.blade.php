...
@section('content')
            ...
            <form action="/edit-user-{{Auth::user()->id}}" method="POST">
                @csrf
                <div class="input">
                ...
                <div class="input">
                    ...
                    <select name="gender" id="gender" value="{{Auth::user()->gender}}">
                ...
                <div class="input">
                    ...
                    <input type="date" name="date" id="date" value="{{Auth::user()->date}}">
                ...
                <div class="input">
                    ...
                    <input type="text" name="street_1" id="street_1" value="{{Auth::user()->street_1}}">
                    <span class="error">{{$errors->first('street_1')}}</span>
                </div>
                <div class="input">
                    <label for="street_2">Street 2</label>
                    <input type="text" name="street_2" id="street_2" value="{{Auth::user()->street_2}}">
                    <span class="error">{{$errors->first('street_2')}}</span>
                </div>
                <div class="input">
                ...
                <div class="input">
                    ...
                    <select name="country" id="country" value="{{Auth::user()->country}}">
                ...
                <button class="btn">Uptade</button>
            </form>
@endsection