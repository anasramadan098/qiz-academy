...
<body>
    ...
    <form class="fill" action="/save-user" method="POST">
        ...
        <div class="inputs">
            ...
            <div class="input">
                ...
                <input type="text" name="username" placeholder="We recommend Email ID as an Username">
            </div>
            <div class="input">
        ...
        <div class="inputs">
            ...
            <div class="input">
                <label>Street 2 <span class="required">*</span></label>
        ...
        <div class="links">
            <a href="/login">You Are user? Log in here</a>
